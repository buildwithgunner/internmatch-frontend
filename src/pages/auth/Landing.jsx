...
const Landing = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#050505] font-sans text-gray-900 dark:text-white antialiased overflow-x-hidden">
            ...
            {/* Split Hero Section */}
            <main className="flex flex-col lg:flex-row min-h-screen pt-[72px]">
                {/* Panel 1: Students */}
                <section className="relative flex-1 lg:hover:flex-[1.2] min-h-[50vh] lg:min-h-0 transition-all duration-700 ease-in-out group overflow-hidden border-b-2 lg:border-b-0 lg:border-r-2 border-black dark:border-white/10">
                    ...
                    <div className="relative h-full flex flex-col justify-end p-8 lg:p-10 z-10 text-white">
                        <h2 className="text-5xl lg:text-6xl font-[1000] leading-[0.85] tracking-tighter mb-4 uppercase">STUDENTS</h2>
                        ...
                        <Link to="/register?role=student" className="flex items-center justify-between bg-white text-black p-5 rounded-xl font-black hover:bg-[#FF6B00] hover:text-white transition-all shadow-xl">
                ...
                <section className="relative flex-1 lg:hover:flex-[1.2] min-h-[50vh] lg:min-h-0 transition-all duration-700 ease-in-out group overflow-hidden border-b-2 lg:border-b-0 lg:border-r-2 border-black dark:border-white/10">
                    ...
                    <div className="relative h-full flex flex-col justify-end p-8 lg:p-10 z-10 text-white">
                        <h2 className="text-5xl lg:text-6xl font-[1000] leading-[0.85] tracking-tighter mb-4 uppercase">RECRUITERS</h2>
                        ...
                        <Link to="/register?role=recruiter" className="flex items-center justify-between bg-[#FF6B00] text-white p-5 rounded-xl font-black hover:bg-white hover:text-black transition-all shadow-xl">
                ...
                {/* Panel 3: Companies */}
                <section className="relative flex-1 lg:hover:flex-[1.2] min-h-[50vh] lg:min-h-0 transition-all duration-700 ease-in-out group overflow-hidden">
                    ...
                    <div className="relative h-full flex flex-col justify-end p-8 lg:p-10 z-10">
                        <h2 className="text-5xl lg:text-6xl font-[1000] leading-[0.85] tracking-tighter mb-4 text-black uppercase">COMPANIES</h2>
                        ...
                        <Link to="/register?role=company" className="flex items-center justify-between bg-black text-white p-5 rounded-xl font-black hover:bg-[#FF6B00] transition-all shadow-xl">
            ...
            <section className="py-20 lg:py-32 px-6 bg-white dark:bg-[#050505]">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row justify-between lg:items-end mb-16 lg:mb-20 gap-8">
                        <div className="max-w-2xl">
                            ...
                            <h2 className="text-4xl lg:text-6xl font-[1000] tracking-tighter leading-none">THE NEW STANDARD FOR <span className="italic">CAREER GROWTH.</span></h2>
                        </div>
                        <p className="text-lg lg:text-xl font-bold text-gray-500 max-w-sm">We've built the world's most intuitive platform for early-career professional development.</p>
                    </div>
            ...
            <section className="py-16 lg:py-24 bg-black text-white overflow-hidden border-y-2 border-white/10">
                <div className="px-6 max-w-7xl mx-auto mb-12">
                    <h3 className="text-3xl lg:text-4xl font-[1000] tracking-tighter uppercase">OPPORTUNITIES IN EVERY FIELD.</h3>
                </div>
                <div className="flex animate-marquee gap-4 lg:gap-6 whitespace-nowrap">
                    {["Marketing", "Engineering", "Digital Design", "Finance", "Healthcare", "Legal", "Public Relations", "Data Science", "Human Resources", "Education"].map((cat, i) => (
                        <div key={i} className="px-6 lg:px-10 py-4 lg:py-6 border-2 border-white/20 rounded-full text-xl lg:text-2xl font-black italic hover:border-[#FF6B00] hover:text-[#FF6B00] transition-all cursor-default uppercase">
                            {cat}
                        </div>
                    ))}
                </div>
            ...
            {/* CTA Final */}
            <section className="py-24 lg:py-40 px-6 relative bg-zinc-50 dark:bg-zinc-900/30">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-5xl lg:text-9xl font-[1000] tracking-tighter leading-[0.85] mb-12 uppercase italic">DON'T MISS YOUR <span className="text-[#FF6B00]">SHOT.</span></h2>
                    <div className="flex flex-col sm:flex-row justify-center gap-4 lg:gap-6">
                        <Link to="/register?role=student" className="bg-black dark:bg-white text-white dark:text-black px-12 py-6 rounded-2xl font-black text-xl hover:scale-105 transition-all shadow-2xl">
                            JOIN NOW
                        </Link>
                        <Link to="/contact" className="border-2 border-black dark:border-white px-12 py-6 rounded-2xl font-black text-xl hover:bg-[#FF6B00] hover:border-[#FF6B00] hover:text-white transition-all shadow-2xl">
                            CONTACT US
                        </Link>
                    </div>
                </div>
            ...
            {/* Footer - RESTORED AND RESPONSIVE */}
            <footer className="py-16 lg:py-20 px-6 border-t-2 border-black dark:border-white/10 bg-white dark:bg-black">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
                    <div>
                        <div className="text-4xl font-[1000] tracking-tighter italic mb-6 uppercase">INTERNMATCH<span className="text-[#FF6B00]">.</span></div>
                        <p className="max-w-xs font-bold text-gray-500">Transforming the bridge between education and professional impact.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-12 lg:gap-20 w-full md:w-auto">
                        <div className="flex flex-col gap-4">
                            <p className="font-black text-[10px] uppercase tracking-[0.2em] text-[#FF6B00]">Navigate</p>
                            <Link to="/about" className="font-bold hover:text-[#FF6B00]">About</Link>
                            <Link to="/blog" className="font-bold hover:text-[#FF6B00]">Journal</Link>
                            <Link to="/careers" className="font-bold hover:text-[#FF6B00]">Careers</Link>
                        </div>
                        <div className="flex flex-col gap-4">
                            <p className="font-black text-[10px] uppercase tracking-[0.2em] text-[#FF6B00]">Legal</p>
                            <Link to="/privacy" className="font-bold hover:text-[#FF6B00]">Privacy</Link>
                            <Link to="/terms" className="font-bold hover:text-[#FF6B00]">Terms</Link>
                        </div>
                    </div>
                </div>
                <div className="max-w-7xl mx-auto mt-16 lg:mt-20 text-[10px] font-black text-gray-400">© 2026 INTERNMATCH INC. GLOBAL.</div>
            </footer>
